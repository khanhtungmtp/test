<?php 
	class Captcha {
		 ...
		 * Create captcha
		*/
		public function create( $min = 5, $max = 10 ) {
		...
		*/
		...
		public function get_image() {
			...
			$bg_path = _UPLOADS . 'backgrounds/';
			$font_path = _VENDORS . 'fonts/';
		 ...
		 * Check captcha
		*/
		public function check( $code, $sensitive = false ) {
			return $sensitive ? $code === $_SESSION['captcha'] : strtolower( $code ) == strtolower( $_SESSION['captcha'] );
		}
	}
?>